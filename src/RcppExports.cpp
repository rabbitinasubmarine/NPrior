...
// Neuro_Linear_custom
Rcpp::List Neuro_Linear_custom(const arma::vec& y, const arma::mat& X, int N, int BURN, arma::colvec alpha, arma::colvec w, arma::colvec sig, double n1, double p1, double eta, double alpha0, double size_a, const int& act_type, const int& SpSL_type, const double& lam1, const double& lam2, const double& lam3, const int& eta_update, const int& alpha0_update, const int& sig_update, const int& K, const int& B_size, const double& a0, const double& b0, const int& prior_sig_type, const int& verbose);
RcppExport SEXP _NPrior_Neuro_Linear_custom(SEXP ySEXP, SEXP XSEXP, SEXP NSEXP, SEXP BURNSEXP, SEXP alphaSEXP, SEXP wSEXP, SEXP sigSEXP, SEXP n1SEXP, SEXP p1SEXP, SEXP etaSEXP, SEXP alpha0SEXP, SEXP size_aSEXP, SEXP act_typeSEXP, SEXP SpSL_typeSEXP, SEXP lam1SEXP, SEXP lam2SEXP, SEXP lam3SEXP, SEXP eta_updateSEXP, SEXP alpha0_updateSEXP, SEXP sig_updateSEXP, SEXP KSEXP, SEXP B_sizeSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP prior_sig_typeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type alpha0(alpha0SEXP);
    Rcpp::traits::input_parameter< double >::type size_a(size_aSEXP);
    Rcpp::traits::input_parameter< const int& >::type act_type(act_typeSEXP);
    Rcpp::traits::input_parameter< const int& >::type SpSL_type(SpSL_typeSEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type prior_sig_type(prior_sig_typeSEXP);
    Rcpp::traits::input_parameter< const int& >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(Neuro_Linear_custom(y, X, N, BURN, alpha, w, sig, n1, p1, eta, alpha0, size_a, act_type, SpSL_type, lam1, lam2, lam3, eta_update, alpha0_update, sig_update, K, B_size, a0, b0, prior_sig_type, verbose));
    return rcpp_result_gen;
END_RCPP
}
// Neuro_ReLU_Linear
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_NPrior_Neuro_Linear_custom", (DL_FUNC) &_NPrior_Neuro_Linear_custom, 26},
